...
namespace NoticiasDISC.Controllers
{
    public class AutorController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AutorId,Nombre,Email,Password")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AutorId,Nombre,Email,Password")] Autor autor)
        {
            if (ModelState.IsValid)
            {
